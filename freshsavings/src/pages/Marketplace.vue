  ...
  <section class="container">
    ...
    <div class="m-3">
      ...
      <div class="container-fluid d-flex justify-content-between">
        <div v-for="category of categories" :key="category.categoryName"
          class="border rounded m-3 p-3 d-flex flex-column justify-content-between col-2 align-items-center">
          ...
          <div v-if="product.posting_status == 'Active'" class="card h-100">
            ...
            <div class="card-body p-4">
              <div class="text-center">
                <!-- Product name-->
                <h5 class="fw-bolder">{{ product.iname }}</h5>
                <!-- Product price-->
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
              <div class="text-center">
                ...
                <!-- Modal -->
                <div class="modal fade modal-lg" id="productDesc" tabindex="-1" aria-labelledby="exampleModalLabel"
                  aria-hidden="true">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="images p-3">
                                        <div class="text-center p-4"> <img id="main-image" :src="productimage"
                                            width="250" /> </div>
                                      ...
                                      <div class="product p-4">
                                        ...
                                        <div class="mt-4 mb-3">
                                          ...
                                          <div class="price d-flex flex-row align-items-center">
                                            <h4 class="act-price">{{ actPrice }}</h4>
                                            <div class="ml-2"> <small class="dis-price">{{ disPrice }}</small>
                                        ...
                                        <div class="sizes mt-5">
                                          <div class="container">
                                            <div class="row">
                                              <h6 class="text-uppercase text-center">Quantity</h6>
                                            </div>

                                            <div class="row">
                                              <div class="cart justify-content-center d-flex ">
                                                <button v-if="qty <= 1" disabled
                                                  class="btn btn-primary text-uppercase mr-2 px-4">-</button>
                                                <button v-else v-on:click="qty--"
                                                  class="btn btn-primary text-uppercase mr-2 px-4">-</button>
                                                <input type="number" style='width: 55px' class="text-center mx-2"
                                                  :value="qty" min="1" :max="max_qty">

                                                <button v-if="qty >= max_qty"
                                                  class="btn btn-primary text-uppercase mr-2 px-4" disabled>+</button>
                                                <button v-else v-on:click="qty++"
                                                  class="btn btn-primary text-uppercase mr-2 px-4">+</button>
